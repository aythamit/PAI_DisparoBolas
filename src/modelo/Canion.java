...
public class Canion {
	...
	private int xInicio; // Posicion inicio x del ca�on
	private int yInicio; // Posicion inicio y del ca�on
	private int xFinal; // Posicion final x del ca�on
	private int yFinal; // Posicion final y del ca�on
